...
$(".hn-fold").click(function() {
  ...
  $(clicked_siblings).each(function() {
    ...
    // var comparison = c_width > original_width;
    // console.log("original_width:" + original_width + ", c_width: " + c_width + ", c_width > original_width:" + (c_width > original_width) + ", comparison:" + comparison);
